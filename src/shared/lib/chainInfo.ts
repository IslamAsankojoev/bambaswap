...
import polygonCircleLogoUrl from '@/public/assets/images/polygonCircle.png'
import { default as arbitrumCircleLogoUrl, default as arbitrumLogoUrl } from '@/public/assets/svg/arbitrum_logo.svg'
import avaxLogo from '@/public/assets/svg/avax_logo.svg'
import avaxSquareLogo from '@/public/assets/svg/avax_square_logo.svg'
import baseLogo from '@/public/assets/svg/base_logo.svg'
import baseSquareLogo from '@/public/assets/svg/base_square_logo.svg'
import bnbSquareLogoUrl from '@/public/assets/svg/bnb_square_logo.svg'
import bnbLogo from '@/public/assets/svg/bnb-logo.svg'
import celoLogo from '@/public/assets/svg/celo_logo.svg'
import celoSquareLogoUrl from '@/public/assets/svg/celo_square_logo.svg'
import optimismSquareLogoUrl from '@/public/assets/svg/optimism_square_logo.svg'
import optimismLogoUrl from '@/public/assets/svg/optimistic_ethereum.svg'
import polygonSquareLogoUrl from '@/public/assets/svg/polygon_square_logo.svg'
import polygonMaticLogo from '@/public/assets/svg/polygon-matic-logo.svg'

import { ARBITRUM_LIST, LINEA_LIST, AVALANCHE_LIST, BASE_LIST, CELO_LIST, OPTIMISM_LIST, PLASMA_BNB_LIST } from '../constants/list'
...
const CHAIN_INFO: ChainInfoMap = {
  ...
  [ChainId.LINEA]: {
    ...
    infoLink: 'https://info.uniswap.org/#',
    label: 'Linea',
    logoUrl: lineaLogoUrl,
    circleLogoUrl: lineaLogoUrl,
