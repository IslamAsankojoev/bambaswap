export const UNI_LIST = 'https://bambaswap.freeblock.site/data/tokens.json'
export const UNI_EXTENDED_LIST = 'https://bambaswap.freeblock.site/data/extendedtokens.json'
...
export const LINEA_LIST = 'https://bridge.arbitrum.io/token-list-42161.json'
